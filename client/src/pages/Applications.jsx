        ...
        <div className='flex gap-6 mb-6 mt-3'>
          {
            (isEdit || (userData && userData.resume === ""))
              ? <>
                ...
                <button disabled={!resume} onClick={updateResume} className='bg-green-100 border border-green-400 rounded-lg px-4 py-2'>Save</button>
              </>
              : <div className='flex gap-2'>
                <a className='bg-blue-100 text-blue-600 px-4 py-2 rounded-lg' href={userData?.resume} target="_blank">View Resume</a>
