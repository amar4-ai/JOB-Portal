...
const ViewApplications = () => {
  ...
  const ChangedJobApplicationStatus = async (id, status) => {
    try {
                ...
                <tr key={index} className='text-gray-700'>
                  ...
                  <td className='py-2 px-4 border-b'>
                    {applicant?.userId?.resume && applicant.userId.resume.trim() !== "" ? (
                      ...
                      <span className="bg-gray-100 text-gray-400 px-3 py-1 rounded inline-flex items-center">
                        No Resume
                      </span>
                    )}
                  </td>
                    ...
                    {applicant.status === 'Pending'
                      ...
                      <div className='relative inline-block text-left group'>
                        ...
                        <div className='z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block'>
                          <button onClick={() => ChangedJobApplicationStatus(applicant._id, 'Accepted')} className='block w-full text-left px-4 py-2 text-blue-500 hover:bg-gray-100'>
                            Accept
                          </button>
                          <button onClick={() => ChangedJobApplicationStatus(applicant._id, 'Rejected')} className='block w-full text-left px-4 py-2 text-red-500 hover:bg-gray-100'>
                            Reject
                          </button>
                        </div>
