...
const Dashboard = () => {
    const { companyToken, companyData, setCompanyData, setCompanyToken } = useContext(AppContext);
    ...
    useEffect(() => {
        if (!loading && !companyToken) {
            navigate("/");
        }
    }, [loading, companyToken]);
    return (
        <div className='min-h-screen'>
            {/* Nvbar for Recruiter panel */}
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='relative group'>
                                ...
                                <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                                    <ul className='lint-none m-0 p-2 bg-white rounded-md border text-sm'>
                ...
                <div className='inline-block min-h-screen border-r-2'>
                    <ul className='flex flex-col items-start pt-5 text-gray-800'>
                        ...
                        <NavLink className={({ isActive }) => `flex items-center p-3 sm:px-6 gap-2 w-full hover:bg-gray-100 ${isActive && 'bg-blue-100 border-r-4 border-blue-500'}`} to={'/dashboard/view-applications'}>
                            ...
                            <p className='max-sm:hidden'>View Applicaions</p>
                        </NavLink>
                    </ul>
                </div>
